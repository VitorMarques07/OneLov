...
CREATE TABLE IF NOT EXISTS deliveries(id INTEGER PRIMARY KEY AUTOINCREMENT,guild_id INTEGER NOT NULL,week_id INTEGER,ticket_id INTEGER,member_id INTEGER NOT NULL,quantity INTEGER NOT NULL,status TEXT NOT NULL DEFAULT 'pending',registered_by INTEGER NOT NULL,reviewed_by INTEGER,created_at TEXT NOT NULL,reviewed_at TEXT);
